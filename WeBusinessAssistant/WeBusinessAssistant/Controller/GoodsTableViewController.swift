...
class GoodsTableViewController: UITableViewController {
    ...
    @IBAction func addGoods(_ sender: UIBarButtonItem) {
        dataShow.append("testData\(dataShow.count+1)")
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(GoodsTableViewCell.self, forCellReuseIdentifier: GoodsTableViewCell.identifier)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.textLabel?.text = dataShow[indexPath.row]
